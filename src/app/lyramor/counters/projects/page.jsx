'use client';
// src/app/lyramor/counters/projects/page.jsx
import { useState, useEffect } from 'react';
import { FiBarChart2, FiSave, FiLoader } from 'react-icons/fi';
...
export default function ProjectCounter() {
  ...
  useEffect(() => {
    const fetchCounter = async () => {
      try {
        const res = await fetch('/api/admin/counters/projects');
  ...
  return (
    <div>
      <div className="mb-6 flex items-center">
        <FiBarChart2 className="text-sky-400 mr-3" size={24} />
        <h1 className="text-2xl font-bold">Project Counter</h1>
      </div>

      <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-6 mb-6">
        <div className="mb-6">
          <p className="text-zinc-400 mb-2">
            This counter displays the total number of projects completed on your portfolio homepage.
          </p>
        </div>
